class WordPuzzleGame extends HTMLElement {
    ...
    setupLocalization() {
        const localisations = {
            ...
            arabic: {
                options: {
                    'محاسبة': 'علم الحسابات المالية',
                    'مدرسة': 'مكان للتعليم',
                    'مستشفى': 'مكان للعلاج الطبي',
                    'كمبيوتر': 'جهاز إلكتروني للحوسبة',
                    'سيارة': 'وسيلة نقل بعجلات',
                    'مطعم': 'مكان لتناول الطعام',
                    'مكتبة': 'مكان الكتب والمطالعة',
                    'برمجة': 'كتابة تعليمات للكمبيوتر',
                    'فلسطين': 'بلد في الشرق الأوسط',
                    'شوكولاتة': 'حلوى مصنوعة من الكاكاو',
                    'هندسة': 'علم التصميم والبناء',
                    'قرآن': 'الكتاب المقدس للمسلمين'
                },
                hint: 'تلميح',
                brand: 'لعبة الكلمات العربية',
                flag: '☪️',
                strapline: 'خمن الكلمة العربية! أعد تحميل الصفحة لكلمة عشوائية جديدة',
                keyboard: [
